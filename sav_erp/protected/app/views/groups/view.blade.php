    ...
    <div class="breadcrumb-line">
 	...
 	<div class="visible-xs breadcrumb-toggle">
	   ...
	   <ul class="breadcrumb-buttons collapse">
	   		<li><a href="{{ URL::to('groups') }}" class="tips" title="Back"><i class="icon-table"></i>&nbsp;</a></li>
			@if($access['is_add'] ==1)
	   		<li><a href="{{ URL::to('groups/add/'.$id) }}" class="tips" title="Edit"><i class="icon-pencil3"></i>&nbsp;</a></li>
			@endif  
