...
{{ HTML::script('sximo/js/simpleclone.js') }}
<script>
...
$(document).ready(function(){
	...
	$("#lookup_table").jCombo("{{ URL::to($module.'/combotable') }}",
	{ selected_value : "<?php echo $f['option']['lookup_table'];?>" });

	$("#lookup_key").jCombo("{{ URL::to($module.'/combotablefield') }}?table=",
	{ selected_value : "<?php echo $f['option']['lookup_key'];?>", parent: "#lookup_table", initial_text : ' Primary Key' });

	$("#lookup_value").jCombo("{{ URL::to($module.'/combotablefield') }}?table=",
	{ selected_value : "<?php echo $f['option']['lookup_value'];?>", parent: "#lookup_table",   initial_text : ' Display Text'}); 
 ...
 {{ Form::open(array('url'=>$module.'/saveformfield/'.$module_name, 'class'=>'form-horizontal')) }}
...
<div class="" style="padding:30px;">			
  ...
  <div class="form-group standart-form datalist"  style="display:none;">
	...
	<div class="col-md-8 ">
		...
		<input type="checkbox" name="is_multiple" class="ext" value="1" <?php if(isset($f['option']['is_multiple']) && $f['option']['is_multiple'] =='1') echo 'checked="checked"';?>  /> Allow Multiple
		</label>		
	 </div> 
  ...
  <div class="form-group standart-form database" style="display:none;">
	...
	<div class="col-md-8">
		...
		<label class="checkbox">
		<select name="lookup_value"  class="ext form-control" id="lookup_value" style="width:100%; ">
		</select>
		</label>
