...
<ul class="nav nav-tabs" style="margin-bottom:10px;">
  	<li ><a href="{{ URL::to($module.'/form/'.$module_name)}}">Form Configuration </a></li> 
	<li class="active" ><a href="{{ URL::to($module.'/formdesign/'.$module_name)}}">Form Layout</a></li> 
</ul>
 {{ Form::open(array('url'=>$module.'/formdesign/'.$module_name,'id'=>'doReorder', 'class'=>'form-vertical','parsley-validate'=>'','novalidate'=>' ')) }}
 ...
 <div class="col-md-4">
	<div class="form-group">
			...
			<label> Once you made changes on layout , to take affect , please rebuild Form Files </label>
