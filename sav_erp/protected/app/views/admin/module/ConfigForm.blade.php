 ...
 <div class="visible-xs breadcrumb-toggle"><a class="btn btn-link btn-lg btn-icon" data-toggle="collapse" data-target=".breadcrumb-buttons"><i class="icon-menu2"></i></a></div>
	...
	@include('admin.module.tab',array('active'=>'form'))
...
<ul class="nav nav-tabs" style="margin-bottom:10px;">
  	<li class="active" ><a href="{{ URL::to($module.'/form/'.$module_name)}}">Form Configuration </a></li> 
	<li ><a href="{{ URL::to($module.'/formdesign/'.$module_name)}}">Form Layout</a></li> 
</ul>
 ...
 <div class="table-responsive">
		...
		<thead class="no-border">
          ...
          <tr>
            ...
            <td><input type="text" name="label[<?php echo $id;?>]" class="form-control input-sm" value="<?php echo $rows['label'];?>" />
	...
	?>
		<select name="required[<?php echo $id;?>]" id="required" class="form-control" style="width:150px;" >
			...
			onclick="SximoModal('{{ URL::to($module.'/editform/'.$row->module_id.'?field='.$rows['field'].'&alias='.$rows['alias']) }}','Edit Field : <?php echo $rows['field'];?>')">
