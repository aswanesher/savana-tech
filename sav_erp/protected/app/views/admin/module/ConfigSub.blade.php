 ...
 <div class="visible-xs breadcrumb-toggle"><a class="btn btn-link btn-lg btn-icon" data-toggle="collapse" data-target=".breadcrumb-buttons"><i class="icon-menu2"></i></a></div>
	...
	@include('admin.module.tab',array('active'=>'sub'))
...
{{ Form::open(array('url'=>$module.'/savesub/'.$module_name, 'class'=>'form-horizontal row box well')) }}
  <div class="col-md-7">
 ...
 {{ Form::close() }}
    ...
    <tbody class="no-border-x no-border-y"> 
      ...
      <tr>
        ...
        onclick="SximoConfirmDelete('{{ URL::to('module/removesub?id='.$row->module_id.'&mod='.$rows['module']) }}');" 
...
$(document).ready(function(){   
    $("#table").jCombo("{{ URL::to('module/combotable') }}",
    { }); 
