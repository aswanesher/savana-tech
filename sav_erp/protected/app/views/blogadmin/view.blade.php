    ...
    <div class="breadcrumb-line">
 	...
 	<div class="visible-xs breadcrumb-toggle">
	   ...
	   <ul class="breadcrumb-buttons collapse">
	   		<li><a href="{{ URL::to('blogadmin') }}" class="tips" title="{{ Lang::get('core.btn_back') }}"><i class="icon-table"></i>&nbsp;</a></li>
			@if($access['is_add'] ==1)
	   		<li><a href="{{ URL::to('blogadmin/add/'.$id) }}" class="tips" title="{{ Lang::get('core.btn_edit') }}"><i class="icon-pencil3"></i>&nbsp;</a></li>
			@endif  
