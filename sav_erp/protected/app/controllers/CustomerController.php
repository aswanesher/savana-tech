...
class CustomerController extends BaseController {
	...
	public function getIndex()
	{
		...
		$sort = (!is_null(Input::get('sort')) ? Input::get('sort') : 'CustomerId'); 
	...
	function postSave( $id =0)
	{
		...
		if ($validator->passes()) {
			...
			$ID = $this->model->insertRow($data , Input::get('CustomerId'));
			// Input logs
			...
			// Redirect after save	
			return Redirect::to('customer')->with('message', SiteHelpers::alert('success',Lang::get('core.note_success')));
		} else {
			return Redirect::to('customer/add/'.$id)->with('message', SiteHelpers::alert('error',Lang::get('core.note_error')))
