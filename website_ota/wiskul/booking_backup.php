		...
		<div class="container pagecontainer offset-0">	
											  ...
											  <div class="tab-content">
												 ...
												 <div class="tab-pane" id="bookmeja">
													<div class="alert alert-info display-none">
														<i class="fa fa-info"></i> Maaf kursi sudah terisi, silahkan pilih kursi yang masih tersedia.
													</div>
													<h4>Ketentuan</h4>
													<div class="form-group">
													<div class="col-md-12">
														...
														<p>4. Tidak di kenakan biaya untuk pemesanan kursi</p>
													</div>
													</div>
													<div class="form-group">
													<div class="col-md-12">	
													   <?PHP 
														$qryMeja 		= "SELECT meja_id,meja_nomor,meja_nomor_pesanan FROM m_wiskul_meja;";
													   ...
													   ?>
														<div class="col-md-3" id="<?PHP echo $meja_id?>" style="border: 1px solid grey;cursor: pointer">
															<img style="margin-left: 21px;margin-right: auto;width: 70%;" src="../images/wiskul_icon/icon_tersedia.png"/>
															<p style="margin-left: 68px;margin-right: auto;"><b style="font-size: 25px"><?PHP echo $meja_nomor?></b></p>
														</div>
														<?PHP
															}else{
														?>
														<div class="col-md-3" style="border: 1px solid grey;cursor: pointer">
			...
			<div class="col-md-4">
				...
				<div class="clearfix paymentGreyContainer">
					...
					<table width="100%">
						<tr>
							<td colspan="3" align="center" ><span class="badge badge-red"><h3><b style="font-family: Freestyle Script;font-size: 25px;">201</b></h3></span></td>
						</tr>
					</table>
					<table width="100%">
						<tr>
					...
					<table width="100%" id="view-mount">
							<tr>
								<td width="3%" align="center"><h4><b style="font-family: Freestyle Script;font-size: 25px;">1.</b></h4></td>
								<td width="60%"><h4><b style="font-family: Freestyle Script;font-size: 25px;">Soto Lamongan</b></h4></td>
								<td align="right"><h4><b style="font-family: Freestyle Script;font-size: 25px;">Rp. 20.000,00</b></h4></td>
							</tr>
							<tr>
								<td colspan="2"><h4><b>Total Pembayaran</b></h4></td>
								<td align="right"><h4><b>Rp. 20.000,00</b></h4></td>
							</tr>
					</table>
					
					<table width="100%" id="loadvoc">
							<tr>
								<td colspan="3">&nbsp;<td>
							</tr>
					</table>
					...
					<table width="100%">
						<tr>
							<td colspan="3" align="center" style="background-color: #70AFC4;color: white"><h4><b style="font-family: Edwardian Script ITC;font-size: 35px;">Waktu Kunjungan</b></h4></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
		...
		function loadCloseForm() {
			...
			$(document).ready(function(){
				...
				$('#cekvoc').bind("click", function () {
					var wiskulId 	= '<?PHP echo $strWiskulId?>';
					var vocode 	= $('input:text[name=voc_code]').val();
					var totyar 	= '<?PHP echo $strWiskulHarga?>';
					...
					$.ajax({
								url: 'getvocrent.php',
								type: 'GET',
								data: 'wiskulId=' + wiskulId + '&vocode=' + vocode + '&totyar='+totyar,
								cache: false,
			...
			$('#formWizard .col-md-3').bind("click", function (event) {
				...
				$.ajax({
					...
					success: function(rescek) {
						...
						var myVar=setInterval(function(){closeform()},1000);
						function closeform() {
							$('#berhasilTiket').hide();
							clearTimeout(myVar);
						}
