...
$.extend(Grid.prototype, {
	...
	bgCellHtml: function(row, col, date) {
		...
		return '<td style="background-color: #FFED90; border-radius: 8px" class="' + classes.join(' ') + '" data-date="' + date.format() + '"></td>';
	},
...
$.extend(DayGrid.prototype, {
	...
	renderSegHtml: function(seg, disableResizing) {
		...
		titleHtml =
			'<span class="fc-title" style="font-size: 20px">Rp. ' +
				(htmlEscape(event.title || '') || '&nbsp;') + // we always want one line of height
			'</span><!--<br><br><center><button>Lihat</button></center><br>-->';
	...
	renderSegPopoverContent: function(date, segs) {
		...
		var content = $(
			'<div class="fc-header ' + view.widgetHeaderClass + '">' +
				...
				'"></span>' +
				'<span class="fc-title">' + htmlEscape(title) + '</span>' +
				'<div class="fc-clear"/>' +
			'</div>' +
