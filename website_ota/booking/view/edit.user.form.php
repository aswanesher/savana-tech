...
$code_id = $_GET['code_id'];
	if(isset($code_id)){
		$quser 	= $conn->query("SELECT  code_safety, code_key_encrypt, code_id,kar_id from authenticated where code_id= '".$code_id."'");
	...
	<div class='box border red' id='formWizard'>
		<div class='box-title'>
			...
			<div class='tools '>
				...
				<a href='javascript:parent.jQuery.fancybox.close();' class='remove'>
					<i class='fa fa-times'></i>
				</a>
			</div>
		</div>
		<div class='box-body form'>
			<form id='wizForm' class='form-horizontal' role="form" action="../proses/adduser.proses.php" method="post" target="_parent">
			...
			<input type="hidden" name="act" value="<?php echo $aksi?>" />
