...
<body>
	<?PHP
			...
			$qrydatahot 	= $conn->query("SELECT * FROM m_facilities WHERE fac_id = ".$_GET['id']."");
...
<br>
								<div class="row">
									<div class="col-md-6">
										...
										<div class="box">
											<div class="box-title">
												<h4>Perbaharui Fasilitas</h4>
											</div>
											<div class="box-body big">
												
												<form class="form-horizontal" action="../proses/addfac.proses.php" method="POST" target="_parent" role="form" enctype="multipart/form-data">
												  <div class="form-group">
													<label for="inputEmail3" class="col-sm-2 control-label">Nama Fasilitas</label>
													<div class="col-sm-5">
													  <input type="text" class="form-control" id="inputEmail3" name="fac_nama" value="<?PHP echo $datahot['fac_nama']?>">
													</div>
												  </div>
												  <div class="form-group">
													<label for="inputPassword3" class="col-sm-2 control-label">Deskripsi</label>
													<div class="col-sm-5">
													  <textarea type="text" class="form-control" id="inputPassword3" name="fac_desk"><?PHP echo $datahot['fac_desk']?></textarea>
													</div>
												  </div>
