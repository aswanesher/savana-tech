											...
											<div class="box-body big">
												...
												<form class="form-horizontal" action="../proses/addhotel.proses.php" method="POST" target="_parent" role="form" enctype="multipart/form-data">
												  <div class="form-group">
													...
													<div class="col-sm-5">
													  <input type="text" class="form-control" id="inputEmail3" name="hotel_nama">
													</div>
												  </div>
												  <div class="form-group">
													<label for="inputPassword3" class="col-sm-2 control-label">Alamat</label>
													<div class="col-sm-5">
													  <textarea class="form-control" id="inputPassword3" name="hotel_address"></textarea>
													</div>
												  </div>
												  <div class="form-group">
												  ...
												  <div class="form-group">
													...
													<div class="col-sm-5">
													  <input type="text" class="form-control" id="inputEmail3" name="hotel_lat">
													</div>
												  </div>
												  <div class="form-group">
													<label for="inputEmail3" class="col-sm-2 control-label">Longitude</label>
													<div class="col-sm-5">
													  <input type="text" class="form-control" id="inputEmail3" name="hotel_lang">
													</div>
												  </div>
												   <div class="form-group">
												  ...
												  <div class="form-group">
													...
													<div class="col-sm-5">
													  <input type="text" class="form-control" style="text-align: right" id="inputEmail3" name="hotel_avg">
													</div>
												  </div>
												  <div class="form-group">
													<div class="col-sm-12">
												  ...
												  <label for="inputPassword3" class="col-sm-2 control-label">Keyword</label>
													<div class="col-sm-5">
													  <textarea class="form-control" id="inputPassword3" name="keyword"></textarea>
													</div>
												  </div>
												   <div class="form-group">
												  ...
												  <div class="form-group">
													...
													<div class="col-sm-5">
													  <input type="text" class="form-control" id="inputEmail3" name="hotel_area">
													</div>
												  </div>
												  <div class="form-group">
													<label for="inputEmail3" class="col-sm-2 control-label">Jml Kamar</label>
													<div class="col-sm-2">
													  <input type="text" class="form-control" id="inputEmail3" name="hotel_jml_kamar">
													</div>
												  </div>
												  <div class="form-group">
													<label for="inputEmail3" class="col-sm-2 control-label">Jml Lantai</label>
													<div class="col-sm-2">
													  <input type="text" class="form-control" id="inputEmail3" name="hotel_jml_lantai">
													</div>
												  </div>
