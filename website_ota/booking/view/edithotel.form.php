											...
											<div class="box-body big">
												...
												<form class="form-horizontal" action="../proses/addhotel.proses.php" method="POST" target="_parent" role="form" enctype="multipart/form-data">
												  <div class="form-group">
													...
													<div class="col-sm-5">
													  <input type="text" class="form-control" id="inputEmail3" name="hotel_nama" value="<?PHP echo $datahot['hotel_nama']?>">
													</div>
												  </div>
												  <div class="form-group">
													<label for="inputPassword3" class="col-sm-2 control-label">Alamat</label>
													<div class="col-sm-5">
													  <textarea class="form-control" id="inputPassword3" name="hotel_address"><?PHP echo $datahot['hotel_address']?></textarea>
													</div>
												  </div>
												  <div class="form-group">
													...
													<div class="col-sm-5">
													  <select class="form-control" id="inputPassword3" name="rate_id">
															<option value="5" <?PHP echo $c = $datahot['rate_id']=="5"?"selected":"";?> > * * * * *</option>
															<option value="4" <?PHP echo $c = $datahot['rate_id']=="4"?"selected":"";?> > * * * *</option>
															<option value="3" <?PHP echo $c = $datahot['rate_id']=="3"?"selected":"";?> > * * *</option>
															<option value="2" <?PHP echo $c = $datahot['rate_id']=="2"?"selected":"";?> > * *</option>
															<option value="1" <?PHP echo $c = $datahot['rate_id']=="1"?"selected":"";?> > *</option>
													  </select>
													</div>
												  </div>
												  <div class="form-group">
													...
													<div class="col-sm-5">
													  <input type="text" class="form-control" id="inputEmail3" name="hotel_lat" value="<?PHP echo $datahot['hotel_lat']?>">
													</div>
												  </div>
												  <div class="form-group">
													<label for="inputEmail3" class="col-sm-2 control-label">Langitude</label>
													<div class="col-sm-5">
													  <input type="text" class="form-control" id="inputEmail3" name="hotel_lang" value="<?PHP echo $datahot['hotel_lang']?>">
													</div>
												  </div>
												   <div class="form-group">
												  ...
												  <div class="form-group">
													...
													<div class="col-sm-5">
													  <input type="text" class="form-control" style="text-align: right" id="inputEmail3" name="hotel_avg" value="<?PHP echo $datahot['hotel_avg']?>">
													</div>
												  </div>
												  <div class="form-group">
													<div class="col-sm-12">
													<div class="alert alert-block alert-warning fade in">
													<p></p><h4><i class="fa fa-exclamation-circle"></i> Perhatian</h4> Tambahkan keyword sebanyak mungkin untuk memudahkan dalam pencarian, pisahkan penulisan dengan tanda koma (,) di akhir kata. <p></p>
													</div>
													</div>
												  </div>
												  <div class="form-group">
												  <label for="inputPassword3" class="col-sm-2 control-label">Keyword</label>
													<div class="col-sm-5">
													  <textarea class="form-control" id="inputPassword3" name="keyword"><?PHP echo $datahot['keyword']?></textarea>
													</div>
												  </div>
												   <div class="form-group">
													<label for="inputPassword3" class="col-sm-2 control-label">Negara</label>
													<div class="col-sm-5">
													  <select class="form-control" id="countSelect" name="count_id">
															<option value="">-- Pilih Negara --</option>
															<?PHP
																$qryhotel 	= "SELECT * FROM m_country";
												  ...
												  <div class="form-group">
													...
													<div class="col-sm-5">
													  <select class="form-control" id="provSelect" name="prov_id">
															<option value="">-- Pilih Provinsi --</option>
															<?PHP
																$qryhotel 	= "SELECT * FROM m_prov";
																$stmthotel 	= $conn->prepare( $qryhotel );
																$stmthotel->execute();
																$i=0;
																while ($rowhotel = $stmthotel->fetch(PDO::FETCH_ASSOC)){
												  ...
												  <div class="form-group">
													...
													<div class="col-sm-5">
													  <select class="form-control" id="kotaSelect" name="kota_id">
															<option value="">-- Pilih Kota --</option>
															<?PHP
																$qryhotel 	= "SELECT * FROM m_kota";
																$stmthotel 	= $conn->prepare( $qryhotel );
																$stmthotel->execute();
																$i=0;
																while ($rowhotel = $stmthotel->fetch(PDO::FETCH_ASSOC)){
																...
																$i++;
															?>
															<option value="<?PHP echo $kota_id?>"><?PHP echo $kota_nama?></option>
															<?PHP
															}
															?>
													  </select>
												  ...
												  <div class="form-group">
													...
													<div class="col-sm-5">
													  <select class="form-control" id="wilSelect" name="wil_id">
															<option value="">-- Pilih Wilayah --</option>
															<?PHP
																$qryhotel 	= "SELECT * FROM m_wilayah";
																$stmthotel 	= $conn->prepare( $qryhotel );
																$stmthotel->execute();
																$i=0;
																while ($rowhotel = $stmthotel->fetch(PDO::FETCH_ASSOC)){
																...
																$i++;
															?>
															<option value="<?PHP echo $wil_id?>"><?PHP echo $wil_nama?></option>
															<?PHP
															}
															?>
													  </select>
												  ...
												  <div class="form-group">
													...
													<div class="col-sm-5">
													  <input type="text" class="form-control" id="inputEmail3" value="<?PHP echo $datahot['hotel_area']?>" name="hotel_area">
													</div>
												  </div>
												  <div class="form-group">
													<label for="inputEmail3" class="col-sm-2 control-label">Jml Kamar</label>
													<div class="col-sm-2">
													  <input type="text" class="form-control" id="inputEmail3" value="<?PHP echo $datahot['hotel_jml_kamar']?>" name="hotel_jml_kamar">
													</div>
												  </div>
												  <div class="form-group">
													<label for="inputEmail3" class="col-sm-2 control-label">Jml Lantai</label>
													<div class="col-sm-2">
													  <input type="text" class="form-control" id="inputEmail3" value="<?PHP echo $datahot['hotel_jml_lantai']?>" name="hotel_jml_lantai">
													</div>
												  </div>
												  ...
												  <div class="form-group">
													<div class="col-sm-offset-2 col-sm-10">
													  ...
													  <input type="hidden" name="res" value="<?PHP echo $_GET['res']?>"/>
