											...
											<div class="box-body big">
												...
												<form class="form-horizontal" action="../proses/addroom.proses.php" method="POST" target="_parent" role="form" enctype="multipart/form-data">
												  ...
												  <div class="form-group">
													...
													<div class="col-sm-1">
													  <input type="text" class="form-control" id="inputPassword3" name="room_avaibility"/>Ruangan
													</div>
												  </div>
												  <div class="form-group">
													<label for="inputPassword3" class="col-sm-2 control-label">Jml Tamu</label>
													<div class="col-sm-1">
													  <input type="text" class="form-control" id="inputPassword3" name="room_jml_org"/>Orang
													</div>
												  </div>
												  <div class="form-group">
													<label for="inputPassword3" class="col-sm-2 control-label">Harga (Rp)</label>
													<div class="col-sm-3">
													  <input type="text" class="form-control" style="text-align: right" id="inputPassword3" name="room_price"/>
													</div>
												  </div>
												  <div class="form-group">
													<label for="inputPassword3" class="col-sm-2 control-label">Discount (%)</label>
													<div class="col-sm-2">
													  <input type="text" class="form-control" id="inputPassword3" name="room_disc"/>
													</div>
												  </div>
												  <div class="form-group">
													<label for="inputPassword3" class="col-sm-2 control-label">Free Breakfast</label>
													<div class="col-sm-2">
													  <input type="checkbox" id="inputPassword3" name="flag_breakfast" value="1"/>
													</div>
												  </div>
												  ...
												  <div class="form-group">
													...
													<div class="col-sm-5">
													  <textarea class="form-control" id="inputPassword3" name="room_tipe_kamar"></textarea>
													</div>
												  </div>
												  <div class="form-group">
													<label for="inputPassword3" class="col-sm-2 control-label">Info Penting</label>
													<div class="col-sm-5">
													  <textarea class="form-control" id="inputPassword3" name="room_info_penting"></textarea>
													</div>
												  </div>
												  <div class="form-group">
													<label for="inputPassword3" class="col-sm-2 control-label">Biaya Tambahan</label>
													<div class="col-sm-5">
													  <textarea class="form-control" id="inputPassword3" name="room_biaya_tambah"></textarea>
													</div>
												  </div>
												  <div class="form-group">
													<label for="inputEmail3" class="col-sm-2 control-label">Image</label>
													<div class="col-sm-5">
													  <input type="file" class="file-input" id="inputEmail3" name="room_image">
													</div>
												  </div>
												  ...
												  <div class="form-group">
													<div class="col-sm-offset-2 col-sm-10">
													  ...
													  <input type="hidden" name="hotel_id" value="<?PHP echo $_SESSION["per"]?>" />
