										...
										<table id="datatable1" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover">
											...
											<tbody>
											<?PHP
												$qryguestbook 	= "SELECT a.book_id,a.kategory_item,a.book_kode,a.very_code,a.book_kode_encrypt,a.name,a.gender,a.email,a.phone,DATE(a.date_input) as tgl_pesan,a.check_in,a.check_out,a.pax,a.noroom,a.flag_confirm,b.book_detail_id,c.hotel_nama FROM guest_book a LEFT JOIN guest_book_detail b ON a.book_id = b.book_id LEFT JOIN m_hotel  c ON a.hotel_id=c.hotel_id WHERE a.rinci_id IS NULL AND a.book_kode IS NOT NULL AND a.hotel_id IS NOT NULL ".$QryStrPemesanan." ORDER BY book_id DESC";
