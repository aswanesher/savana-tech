...
<html lang="en">
  ...
  <body>
    ...
    <main>
	  ...
	  <h2 class="name">Rental Mobil '.$qrycekguest['rent_merk'].' '.$qrycekguest['hotel_nama'].'</h2> 
	  <br>
	  <!--BARU-->
	  <table width="100%" style="background-color: white">
			...
			<tr>
				<td >Tujuan </td>
				<td >:</td>
				<td ><b>'.$qrycekguest['rent_tujuan'].'</b></td>
				<td >Jumlah Penumpang</td>
				<td >:</td>
				<td ><b>'.$qrycekguest['rent_jml_penumpang'].' Orang</b></td>
			</tr>
		...
		<h2 class="name">Waktu Pengambilan Kendaraan :</h2>  
	  ...
	  <table width="100%" style="background-color: white">
			<tr style="background-color: #FF9600;color: white">
				...
				<td >Pukul</td>
				<td >:</td>
				<td ><b>'.$qrycekguest['rent_jam'].'</b></td>
			</tr>
		  
	  </table>
	  <h2 class="name">Waktu Pengembalian Kendaraan :</h2>  
	  
	  <table width="100%" style="background-color: white">
			<tr style="background-color: #FF9600;color: white">
				<td >Hari/ Tanggal </td>
				<td >:</td>
				<td ><b>'.fullDateDay($qrycekguest['check_out']).'</b></td>
				<td >Pukul</td>
				<td >:</td>
				<td ><b>'.$qrycekguest['rent_jam'].'</b></td>
			</tr>
	  ...
	  <h2 class="name">Permintaan Tambahan :</h2>  
	  
	  <table width="100%">
			<tr style="background-color: #FF9600;color: white">
				<td width="20%">Permintaan </td>
				<td width="2%">1. </td>
				<td ><b>'.$qrycekguest['rent_permintaan'].'</b></td>
			</tr>
			<tr>
				<td style="background-color: #FF9600;color: white;border-right: 1px solid white" >&nbsp;</td>
				<td style="background-color: #FF9600;color: white;border-right: 1px solid white">2. </td>
				<td style="background-color: #FF9600;color: white;border-right: 1px solid white"><b>'.$permintaanRent.'</b></td>
			</tr>
	  </table>	
