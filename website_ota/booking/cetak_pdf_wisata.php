...
<html lang="en">
  ...
  <body>
    ...
    <main>
	  ...
	  <h2 class="name">Obyek Wisata '.$qrycekguest['hotel_nama'].'</h2> 
	  <br>
	  <!--BARU-->
	  <table width="100%" style="background-color: white">
			...
			<tr>
				<td >Tujuan </td>
				<td >:</td>
				<td ><b>'.$qrycekguest['obj_tujuan'].'</b></td>
				<td >Jumlah Orang</td>
				<td >:</td>
				<td ><b>Dewasa ('.$qrycekguest['obj_dewasa'].'), Anak ('.$qrycekguest['obj_anak'].')</b></td>
			</tr>
		...
		<h2 class="name">Tiket Yang Telah Dipesan :</h2>  
	  
	  <table width="100%" style="background-color: white">
			<tr style="background-color: #FF9600;color: white">
				<td >Tiket Untuk Dewasa </td>
				<td >:</td>
				<td ><b>'.$qrycekguest['obj_dewasa'].' Tiket</b></td>
				<td >Tiket Untuk Anak</td>
				<td >:</td>
				<td ><b>'.$qrycekguest['obj_dewasa'].' Tiket</b></td>
			</tr>
		...
		<h2 class="name">Permainan Tambahan :</h2> 
	  
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <thead>
		<tr style="background-color: #FF9600;color: white">
			<td width="50%">Nama Permainan</td>
            <td width="50%">Jumlah Tiket</td>
          </tr>';
			$qryguestbook 	= "SELECT b.tiket_nama,count(a.tiket_id) as jumlah FROM guest_book_wisata_detail a INNER JOIN m_tiket b ON a.tiket_id = b.tiket_id WHERE a.guest_book_wisata_detail_kode = '".$qrycekguest['guest_book_wisata_detail_kode']."' GROUP BY a.tiket_id";
