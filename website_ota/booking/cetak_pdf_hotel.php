	  ...
	  <table width="100%" style="background-color: white">
		 <tr>
		  ...
		  <tr>
		   ...
		   <div class="notice">Setiap pembatalan yang diterima dalam waktu 2 hari sebelum tanggal kedatangan akan dikenakan biaya. Kegagalan untuk tiba di tempat akan diperlakukan sebagai Tidak Hadir dan akan dikenakan biaya (kebijakan Hotel).
		</div><br>
		...
		<!-- <h2 class="name">Telah Dibayar Melalui:</h2> 
		  ...
		  <h2 class="name">Dengan Rincian Pemesanan Sebagai Berikut:</h2> 
	  
		  <table width="100%" style="background-color: #FF9600;color: white">
				<tr>
					<td >Tgl Check-In</td>
					<td >:</td>
					<td style="border-right: 1px solid white"><b>'.fullDateDay($qrycekguest['check_in']).'</b></td>
					<td >Tgl Check-Out</td>
					<td >:</td>
					<td style="border-right: 1px solid white"><b>'.fullDateDay($qrycekguest['check_out']).'</b></td>
					<td >Durasi</td>
					<td >:</td>
					<td ><b>'.$tot_day->format("%a").' Malam</b></td>
				</tr>
