			...
			<div class="rightcontent col-md-12 offset-0">
				...
				<thead>
					<tr>
						...
						<td align="center" style="border-bottom: 2px solid grey">Maskapai</td>
						<td style="border-bottom: 2px solid grey" width="8%">Brgkt</td>
						<td style="border-bottom: 2px solid grey">&nbsp;</td>
						<td style="border-bottom: 2px solid grey" width="8%">Tiba</td>
						<td style="border-bottom: 2px solid grey" align="center">Fasilitas</td>
						<td style="border-bottom: 2px solid grey">Durasi</td>
						<td style="border-bottom: 2px solid grey">Harga Per Orang</td>
						<td style="border-bottom: 2px solid grey">&nbsp;</td>
					</tr>
				</thead>
				<?PHP
					$qryPlane 	= "SELECT hotel_id,hotel_img,hotel_nama,TIME(plane_berangkat) as berangkat,TIME(plane_tiba) as tiba,TIMESTAMPDIFF(HOUR,plane_berangkat,plane_tiba) AS jam,hotel_avg FROM m_hotel WHERE kode_kategory = '".$kodePlane."'";
				...
				<tbody style="cursor: pointer;">
					<tr>
						<td style="border-left: 1px solid grey;border-bottom: 1px solid grey;" width="2%" rowspan="3">&nbsp;</td>
					...
					<tr>
						...
						<td><b><?PHP echo $jam?> Jam</b></td>
						<td style="border-right: 1px solid grey;"><?PHP echo $hotel_avg?></td>
						<td style="border-right: 1px solid grey;"><button class="bookbtn" type="submit"><span class="white size14">Pesan sekarang</span></button></td>
					</tr>
					<tr>
