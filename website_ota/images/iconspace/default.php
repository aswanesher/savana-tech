...
<!--
	...
	<div class="wrap bgfix cstyle03">
						...
						<div id="hotel" class="tab-pane fade active in">
							...
							<table width="100%">
								<tr>
									...
									<td width="50%" ><b>1. Tujuan Menginap</b><br><font style="font-size: 14px">Area Tujuan, atau nama hotel </font><br><input type="text" name="tags" class="form-control" value="<?PHP echo $wilayah?>" id="" placeholder="Ketik nama daerah atau nama hotel"></td>
		...
		<div class="container cstyle07">
				...
				<center><h3 style="color:red;text-decoration: underline;"><b>DEMO SITE</b></h3><h3>Hotel Partner</h3>
				</center>
				<div class="col-md-4">
				<div class="box_1 center">
					<img src="images/iconspace/poplogo2.png" alt=""/>
				</div>
						<!--<p class="lato bold caps">Sistem Pelayanan Prima</p>-->
						<p style="font-size: 12px;text-align: center; margin-top: -25px;" align="center">
						Terletak di jantung kota Bandung, POP! Hotel Bandung Festival CityLink merupakan lokasi ideal untuk menjelajahi Bandung. Dari sini, para tamu dapat menikmati akses mudah ke semua hal yang ditawarkan oleh kota ini. </p>
				</div>
			
				<div class="col-md-4">
				<div class="box_1 center">
					<img src="images/iconspace/park-logo.png" alt=""/>
				</div>
						<!--<p class="lato bold caps">Sistem Pelayanan Prima</p>-->
						<p style="font-size: 12px;text-align: center; margin-top: -25px;" align="center">
						Park Hotel Bandung terletak strategis di Pusat Kota Bandung, Dengan lokasinya yang hanya 3 Km dari pusat kota dan 10 Km dari bandara, hotel bintang 4 ini menarik perhatian banyak wisatawan setiap tahun.</p>
				</div>

				<div class="col-md-4">
				<div class="box_1 center">
					<img src="images/iconspace/horison-logo.png" alt=""/>
				</div>
						<!--<p class="lato bold caps">Sistem Pelayanan Prima</p>-->
						<p style="font-size: 12px;text-align: center; margin-top: -25px;" align="center">
						Salah satu hotel terbaik di Bandung, cocok untuk wisatawan bisnis ataupun wisatawan yang mencari sedikit kemewahan. Iklim yang sejuk dari kota Bandung menjadikannya sebagai pilihan populer untuk melakukan liburan akhir pekan.</p>
				</div>
		...
		<div class="divider15">&nbsp;</div>
			<div class="col-md-12" style="min-height: 84px; background-color: #FFA500; padding-top: 10px;">
				<div class="col-md-4">
					<div class="box_1 center">
							<p class="lato bold caps">Info Promo Terbaik Dari Walanja.co.id</p>
					</div>
				</div>
				<div class="col-md-4">
					<div class="box_1 center">
				...
				<div class="col-md-4">
					...
					<div class="col-md-4">
						<div class="socialWidgetBox">
						   ...
						   <a href="https://twitter.com/walanjacoid" class="twitter-follow-button" data-show-count="false" data-size="large">Follow @walanjacoid</a>
					...
					<div class="socialWidgetTitle">
					  <a href="https://facebook.com/walanjacoid" title="walanjacoid di Facebook"><div class="tvContactIcon2 tvContactFacebookIcon"></div>walanjacoid</a>
						...
						<iframe src="http://www.facebook.com/plugins/likebox.php?href=https://www.facebook.com/walanjacoid?fref=ts&amp;width=270&amp;colorscheme=light&amp;show_faces=true&amp;border_color=white&amp;stream=false&amp;header=false&amp;height=320" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:300px; height:320px;"></iframe>
					</div>
...
<center><h3 style="color:red;text-decoration: underline;"><b>DEMO SITE</b></h3></center>	
	...
	function radioSekali(){
		$('#showTglPlng').hide();
		$('#datepicker4').hide();
	}
	
	function radioPulang(){
		$('#showTglPlng').show();
		$('#datepicker4').show();
	}
