		<div class="col-md-7 offset-0">
			<table border="1" width="100%">
				...
				<tr>
					<td align="center"><h4><b><?PHP echo $strDataTerakhir['meja_nomor']?></b></h4></td>
				</tr>
			</table>
		</div>
		<div class="col-md-7 offset-0" style="margin-top: 10px;">
			...
			<table border="1" width="100%">
				...
				<?PHP
					...
					$qryMenuMasakan	= "SELECT a.pesanan_id,b.menu_masakan_nama,b.menu_masakan_id,b.menu_harga,COUNT(b.menu_masakan_id) as total_pesan,SUM(b.menu_harga) as total FROM m_menu_pesanan a INNER JOIN m_menu_masakan b ON a.menu_masakan_id = b.menu_masakan_id WHERE a.hotel_id = '".$strDataTerakhir['hotel_id']."' AND a.meja_nomor_pesanan = '".$strDataTerakhir['meja_nomor_pesanan']."' GROUP BY a.menu_masakan_id ORDER BY a.pesanan_id DESC";
