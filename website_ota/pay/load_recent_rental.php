		<?PHP
			$qryCekPesanan	= $conn->query("SELECT b.rent_merk,b.hotel_nama,a.rent_tujuan,a.rent_jml_penumpang,a.check_in,a.check_out,a.rent_jam,b.hotel_avg,a.flag_supir,b.rent_harga_supir FROM guest_book a INNER JOIN m_hotel b ON a.hotel_id = b.hotel_id WHERE a.hotel_id = '".$strDataTerakhir['hotel_id']."'");
